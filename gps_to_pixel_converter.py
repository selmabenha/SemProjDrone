...
# # def get_median_displacement_vector(image0, image1):
# #     m_kpts0, m_kpts1 = extract_matches(image0, image1, 1, True)
# #     displacement_vectors = m_kpts1 - m_kpts0
# #     displacement_vector_median = torch.median(displacement_vectors, dim=0).values
# #     return displacement_vector_median
...
with open('drone_coords_new.csv', 'w', newline='') as file:
    columns = [[
        ...
        'pix_med_displacement_vector_wrt_ref',
        'is_reference'
        ]]
    data = [[
        index + 1,
